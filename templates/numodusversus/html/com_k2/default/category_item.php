...
<div class="liBlock catItemView group<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' liItemIsFeatured catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
  ...
  <?php endif; ?>		
	...
	<div class="column<?php if (!$this->item->params->get('catItemDateCreated')) echo ' small-12'; else echo ' small-11'; ?> liItemBodyBlock">
    ...
    <?php endif; ?>
      ...
      <?php if($this->item->params->get('catItemAuthor') || $this->item->params->get('catItemCategory') || $this->item->params->get('catItemCommentsAnchor') || ($this->item->params->get('catItemTags') && count($this->item->tags))): ?>
    ...
    <div class="liItemLinks catItemLinks">
  		...
  		<div class="liItemHitsBlock catItemHitsBlock">
  			<span class="liItemHits catItemHits">
  	  ...
  	  <!-- Item attachments -->
  	  <div class="liItemAttachmentsBlock catItemAttachmentsBlock">
  		  <span><?php echo JText::_('K2_DOWNLOAD_ATTACHMENTS'); ?></span>
  		  <ul class="liItemAttachments catItemAttachments">
    ...
    <div class="liItemVideoBlock catItemVideoBlock">
    	<h3><?php echo JText::_('K2_RELATED_VIDEO'); ?></h3>
  		...
  		<div class="liItemVideoEmbedded catItemVideoEmbedded">
  			<?php echo $this->item->video; ?>
  		</div>
  		<?php else: ?>
  		<span class="liItemVideo catItemVideo"><?php echo $this->item->video; ?></span>
  		<?php endif; ?>
    </div>
    <?php endif; ?>
    ...
    <!-- Item image gallery -->
    <div class="liItemImageGallery catItemImageGallery">

...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="modUserBlock k2UserBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">

	<div class="modUserBlockDetails k2UserBlockDetails">
      ...
      <span class="ubGreeting"><?php echo $userGreetingText; ?></span>
    <?php endif; ?>
  ...
  <ul class="userBlockActions">
	...
	<ul class="userBlockRenderedMenu">

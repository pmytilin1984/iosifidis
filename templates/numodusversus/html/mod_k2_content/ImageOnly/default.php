...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="modItemsBlock k2ItemsBlock<?php //if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
  ...
  <ul>
    ...
    <li class="<?php echo ($key%2) ? "odd" : "even"; if(count($items)==$key+1) echo ' lastItem';  echo ' image'.($key+1); ?>">

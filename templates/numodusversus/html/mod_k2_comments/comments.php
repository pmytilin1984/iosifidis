...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="modCCBlock k2LatestCommentsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
	...
	<ul>
      ...
      <div class="clr"></div>
			...
			<span class="lcCommentDate">
				...
				<?php else: ?>
				<?php echo JText::_('K2_ON'); ?> <?php echo JHTML::_('date', $comment->commentDate, 'd F Y, H:i'); ?>
				<?php endif; ?>
			</span>
			<?php endif; ?>
			...
			<span class="lcItemCategory"><?php echo JText::_('K2_IN'); ?> <a href="<?php echo $comment->catLink; ?>"><?php echo $comment->categoryname; ?></a></span>
			<?php endif; ?>
